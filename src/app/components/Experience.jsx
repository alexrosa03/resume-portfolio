    ...
    <section id="experience" className="min-h-screen flex flex-col px-4">
      ...
      <ol className="relative border-s border-gray-200 dark:border-gray-700">                  
        <li className="mb-10 ms-4">
          ...
          <time className="mb-1 text-sm font-normal leading-none text-gray-400">January 2025 - Present</time>
          <SlideInSection direction="right">  
            <h3 className="text-lg font-bold">Software Engineer - <span className="font-normal">IFood Logistics</span></h3>
        ...
        <li className="mb-10 ms-4">
          <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
          <time className="mb-1 text-sm font-normal leading-none text-gray-400">  March 2023 - June 2024</time>
          <SlideInSection direction="right">  
            <h3 className="text-lg font-bold">Software Developer - <span className="font-normal">Newlogic</span></h3>
        ...
        <li className="ms-4">
          <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
          <time className="mb-1 text-sm font-normal leading-none text-gray-400">Aug 2022 - March 2025</time>
          <SlideInSection direction="right">  
            <h3 className="text-lg font-bold">Volunteer Web Developer and Arma 3 Scripting - <span className="font-normal">Passion Project</span></h3>
            <p className="text-base font-normal text-gray-400">
